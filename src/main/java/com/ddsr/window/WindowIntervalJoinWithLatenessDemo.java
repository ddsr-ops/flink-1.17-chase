...
import com.ddsr.watermark.WatermarkOutOfOrdernessDemo;
...
/**
 *
 * Window Interval Join with Late Data
 *
 * @author ddsr, created it at 2023/9/3 19:22
 */
public class WindowIntervalJoinWithLatenessDemo {
    public static void main(String[] args) throws Exception {
         ...
         * 5、如果 当前数据的事件时间 < 当前的watermark，就是迟到数据， 主流的process不处理（乱序指的是事件事件小的比事件时间大的晚来）
         *  => between后，可以指定将 左流 或 右流 的迟到数据 放入侧输出流
         *
         *  关于设置乱序后，WaterMark如何推进， 可以参考{@link WatermarkOutOfOrdernessDemo}
         */
        ...
        SingleOutputStreamOperator<String> process = ks1.intervalJoin(ks2)
                .between(Time.seconds(-2), Time.seconds(2)) // With the watermark going on, relevant windows will be closed
