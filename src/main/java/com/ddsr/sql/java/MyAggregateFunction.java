...
/**
 * @author ddsr, created it at 2023/12/4 22:18
 */
public class MyAggregateFunction {
    public static void main(String[] args) throws Exception {
        ...
        //  姓名，分数，权重
        // Compute the value: score1 * weight1 + score2 * weight2 + score3 * weight3 / weight1 + weight2 + weight3
    ...
    public static class WeightedAvg extends AggregateFunction<Double, Tuple2<Integer, Integer>> {
        ...
        /**
         *
         * This method must be manually writen, which can not be overrided
