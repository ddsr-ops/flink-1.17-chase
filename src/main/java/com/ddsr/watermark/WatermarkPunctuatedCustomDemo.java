...
/**
 * Custom punctuated watermark
 *
 * @author ddsr, created it at 2023/8/26 16:42
 */
public class WatermarkPunctuatedCustomDemo {
    ...
    public static class MyPunctuatedWatermarkGenerator<WaterSensor> implements WatermarkGenerator<WaterSensor> {
        ...
        public MyPunctuatedWatermarkGenerator(long outOfOrderness) {
        ...
        public void onEvent(WaterSensor event, long eventTimestamp, WatermarkOutput output) {
            ...
            System.out.println("Invoke the onEvent method, current maxTs=" + maxTs + ", watermark=" + new Watermark(maxTs - outOfOrderness - 1));
        }
